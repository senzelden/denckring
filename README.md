...
$ denckring status
158 catalogued · 133 implementable · 133 implemented · 133 validated · 25 not mechanically checkable
...
A hundred and thirty-three of the 158 catalogued procedures are implemented, and every
...
and all 133 implementable procedures are implemented.
...
| `denckring[en]` | pronouncing dictionary, noun lexicon, SCOWL graded word list, relations and proverbs | exact syllables instead of estimates; `apply anagram` |
...
| `denckring[de-wiktionary]` | pronunciations, stress, glosses (CC BY-SA) | German phonetic and gloss-based rows; no English-only relations or POS |
| `denckring[de-frequency]` | frequency bands, from the Leipzig Corpora Collection (CC BY) | German `apply anagram` |
| `denckring[fr]` | word list, nouns, frequency bands, glosses, syllables, phonemes (Lexique 3.82, fr.Wiktionary) | French from 72 rows to **108** |
...
On core alone, 72 of the 133 implemented rows run in French.
