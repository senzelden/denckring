...
character by character out of them.
...
are instead: the **band** of columns folding at one moment (12-23 as shipped,
61-65 at zero, ceiling 35) and how far the **front** of that band advances
across the clatter (38.5-53.9 columns as shipped, 1.2-13.2 at zero, floor 20),
